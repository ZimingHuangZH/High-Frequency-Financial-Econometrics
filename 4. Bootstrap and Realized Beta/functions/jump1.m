function [j] =jump1(lamda,T,n,sigma_jump)
...
% sigma_jump is the standard variance of jump
  j=[];
  ...
  y=random('normal',0,sigma_jump,N,1);% the size of jumps follow normal distribution with mean=0,sd=(18*sigma)/sqrt(n)
  for i=1:T*n
      k=0;     
